...
- After changing code, verify it: run the tests, a linter, or a syntax/compile check (e.g. \`node --check\`, \`python3 -m py_compile\`). Don't run the app itself to test it.
